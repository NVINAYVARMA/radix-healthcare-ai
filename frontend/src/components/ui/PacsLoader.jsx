      ...
      <div className="pacs-scanner-card">
        ...
        <div className="pacs-scanner-viewport">
          ...
          >
            ...
            />
            {/* Rib Arcs */}
            <path d="M75 65 C60 72 60 90 75 95" stroke="#ffffff" strokeWidth="1.8" opacity="0.6" />
            <path d="M125 65 C140 72 140 90 125 95" stroke="#ffffff" strokeWidth="1.8" opacity="0.6" />
            <path d="M78 105 C62 112 62 130 78 135" stroke="#ffffff" strokeWidth="1.8" opacity="0.6" />
            <path d="M122 105 C138 112 138 130 122 135" stroke="#ffffff" strokeWidth="1.8" opacity="0.6" />
